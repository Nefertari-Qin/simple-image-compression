...
//     varpng.writeToFile("images/out/output-comp-var-stanley");
	...
	PNG origIm;
	origIm.readFromFile("images/self/mdr_residence.png");

	// use it to build a quadtree
	
	qtcount c(origIm);
	qtcount qtcountCopy(c);

	// prune the quadtree
	qtcountCopy.prune(10000); 

    
	// render the quadtree
	PNG ppic = qtcountCopy.render();


	ppic.writeToFile("images/result/prune10000-mdr_residence-count.png");
	...
	// prune the quadtree
	qtVarCopy.prune(10000); 
	
	// render the quadtree
	PNG vpic = qtVarCopy.render();


	vpic.writeToFile("images/result/prune10000-mdr_residence-var.png");
    ...
    countcomp.prune(countcomp.idealPrune(66666));
    varcomp.prune(varcomp.idealPrune(66666));
...
*/
    ...
    countpng.writeToFile("images/result/idealprune66666-mdr_residence-comp-count.png");
    varpng.writeToFile("images/result/idealprune66666-mdr_residence-comp-var.png");
